...
// Route: PATCH /api/taskerBookings/:taskId/status
router.patch('/:taskId/status', verifyToken, updateQuoteStatus);
router.get("/request-quotes/client/:clientId", getRequestQuotesByClientId);
router.patch("/request-quotes/:id", updateRequestQuote);
router.delete("/request-quotes/:id",verifyToken, deleteRequestQuote);

// Bidding Routes
router.post("/request-quotes/:quoteId/bid", verifyToken, submitBid);
router.post("/request-quotes/:quoteId/accept-bid/:bidId", verifyToken, acceptBid);
router.post("/request-quotes/:quoteId/reject-bid/:bidId", verifyToken, rejectBid);
